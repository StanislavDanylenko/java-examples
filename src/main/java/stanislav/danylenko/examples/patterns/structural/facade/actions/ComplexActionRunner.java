package stanislav.danylenko.examples.patterns.structural.facade.actions;

import stanislav.danylenko.examples.patterns.structural.facade.actions.components.SomeAction1;
import stanislav.danylenko.examples.patterns.structural.facade.actions.components.SomeAction2;
import stanislav.danylenko.examples.patterns.structural.facade.actions.components.SomeAction3;
import stanislav.danylenko.examples.patterns.structural.facade.actions.components.SomeAction4;
import stanislav.danylenko.examples.patterns.structural.facade.actions.components.SomeAction5;

public class ComplexActionRunner {
